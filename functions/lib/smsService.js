...
exports.formatIndianPhoneNumber = formatIndianPhoneNumber;
exports.sendEscalationSms = sendEscalationSms;
/**
 ...
 */
async function sendTwilioSms(accountSid, authToken, fromPhone, toPhone, body) {
 ...
 */
async function sendFast2Sms(apiKey, toPhone, body) {
 ...
 */
function sendMockupSms(toPhone, body, recipientRole) {
 ...
 */
async function sendEscalationSms(payload) {
    ...
    if (twilioSid && twilioAuth && twilioFrom) {
        try {
            return await sendTwilioSms(twilioSid, twilioAuth, twilioFrom, payload.recipientPhone, payload.messageBody);
        }
        catch (err) {
    ...
    if (fast2SmsKey) {
        try {
            return await sendFast2Sms(fast2SmsKey, payload.recipientPhone, payload.messageBody);
        }
        catch (err) {
    ...
    return sendMockupSms(payload.recipientPhone, payload.messageBody, payload.recipientRole);
}
